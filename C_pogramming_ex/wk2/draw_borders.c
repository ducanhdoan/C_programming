// draws a border around the inner edge of the terminal window

#include <cab202_graphics.h>


void draw_border( void ) {
	// (a) Declare an integer variable called left, with an initial value of 0.
	int left=0;

	// (b) Declare an integer variable called top, with an initial value of 2.
	int top=2;

	// (c) Declare an integer variable called right, with an initial value 4 
	//     less than the largest visible horizontal location in the terminal window.
	int right=screen_width()-4-1;
