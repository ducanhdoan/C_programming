// simulates the flight of an object orbiting under the gravitational influence of a star. 
...
void setup(void) {
    ...
    //      initial location which is displaced 10 units to the left and 
    //      9 units above the star.
	station= sprite_create(x_star-10,y_star-9,1,1,station_img);
