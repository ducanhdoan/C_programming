// program that reads the state of the five-way switch (thumb-controlled joystick), and controls the LEDs mounted on the Teensy circuit board.
...
void process_game_controller( void ) {
    ...
    {
        /* code */
        // if (BIT_VALUE(PINB,2)==1)
        // {
        //     /* code */
        //     CLEAR_BIT(PORTB,2);
        // }
        // else if (BIT_VALUE(PINB,2)==0)
        // {
        //     SET_BIT(PORTB,2);
        // }

        // if (BIT_VALUE(PINB,3)==1)
        // {
        //     /* code */
        //     CLEAR_BIT(PORTB,3);
        // }
        // else if (BIT_VALUE(PINB,3)==0)
        // {
        //     SET_BIT(PORTB,3);
        // }
        TOGGLE_BIT(PORTB,2);
